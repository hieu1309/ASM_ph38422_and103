...
public class PhoneLogin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mCallBack = new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
            ...
            public void onVerificationFailed(@NonNull FirebaseException e) {
                ...
                Toast.makeText(PhoneLogin.this, "Lỗi rồi", Toast.LENGTH_SHORT).show();
            }
    ...
    private void getOTP(String phoneNumber) {
        if (!phoneNumber.isEmpty()) {
            ...
            Toast.makeText(PhoneLogin.this, "Nhập số điện thoại trước", Toast.LENGTH_SHORT).show();
        }
    }
    private void verifyOTP(String code) {
        if (!code.isEmpty()) {
            ...
            Toast.makeText(PhoneLogin.this, "Nhập mã OTP trước", Toast.LENGTH_SHORT).show();
        }
    }
                ...
                .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            // Thành công
                            Toast.makeText(PhoneLogin.this, "Đăng nhập thành công", Toast.LENGTH_SHORT).show();
                            ...
                            if (task.getException() instanceof FirebaseAuthInvalidCredentialsException) {
                                ...
                                Toast.makeText(PhoneLogin.this, "Mã xác minh không hợp lệ", Toast.LENGTH_SHORT).show();
                            } else {
                                // Xử lý các trường hợp thất bại khác nếu cần
                                Toast.makeText(PhoneLogin.this, "Đăng nhập thất bại", Toast.LENGTH_SHORT).show();
                            }
                        }
